...
Pour accéder au partage via l'explorateur de Windows, saisir : \\adresse_ip_orangepi'
echo
echo
...
echo
echo "L'utilisateur 'pi' peut y accéder avec son MDP associé (orangepi par défaut)."
